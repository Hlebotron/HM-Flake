  ...
  programs = {
    ...
    bash = {
      ...
      shellAliases = {
        ...
        addtimepc = "ssh sasha@192.168.1.103 \"~/addtime.sh $1\"";
        addtimedell = "ssh sasha@192.168.1.182 \"~/addtime.sh $1\"";
        ...
        c = "z";
        dev = "nix develop";
        timeleftpc = "ssh sasha@192.168.1.103 \"echo $(($(cat /opt/limit/ticksLeft) * $(cat /opt/limit/tickLengthSecs) / 60))\"";
        timeleftdell = "ssh sasha@192.168.1.182 \"echo $(($(cat /opt/limit/ticksLeft) * $(cat /opt/limit/tickLengthSecs) / 60))\"";
      };
      initExtra = "fastfetch";
      #shellInit = "fastfetch";
